<script setup>
import MyAccountAvatar from "@/views/pages/MyAccountPage/ui/mobile/components/MyAccountAvatar.vue";
...
import Logout from "@/views/pages/MyAccountPage/ui/mobile/components/Logout.vue";

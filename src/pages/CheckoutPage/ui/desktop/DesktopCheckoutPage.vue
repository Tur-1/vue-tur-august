...
import CheckoutCouponForm from "@/pages/CheckoutPage/views/desktop/components/CheckoutCouponForm.vue";
import CheckoutDetails from "@/pages/CheckoutPage/views/desktop/components/CheckoutDetails.vue";
